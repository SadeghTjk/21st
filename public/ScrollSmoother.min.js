...
!(function (e, t) {
    ...
    r =
      ((ScrollSmoother.register = function register(e) {
        return (
          L ||
            ((I = e || t()),
            s() && window.document && ((U = window), (G = document), (j = G.documentElement), (K = G.body)),
            I &&
              ((q = I.utils.toArray),
              (D = I.utils.clamp),
              (Y = I.parseEase("expo")),
  ...
  function ScrollSmoother(t) {
    ...
    function Sa(r, e, t, n, o) {
      function bc() {
        (e = u()), (t = parseFloat(h().value)), (i = parseFloat(e.value) || 1), (a = "auto" === e.value), (c = a || (s && s._startClamp && s.start <= 0) || p.offset ? 0 : s && s._endClamp && s.end === v() ? 1 : 0.5), l && l.kill(), (l = t && I.to(r, { ease: Y, overwrite: !1, y: "+=0", duration: t })), s && ((s.ratio = i), (s.autoSpeed = a));
      }
      function cc() {
        ...
        if (a) {
          ...
          var t = (function _autoDistance(e, t) {
            var r,
              ...
              f = -c * t;
            return 0 < c && ((n = 0.5 == (r = s.height / (U.innerHeight + s.height)) ? 2 * s.height : 2 * Math.min(s.height, Math.abs((-c * r) / (2 * r - 1))) * (t || 1)), (f += t ? -n * t : -n / 2), (c += n)), { change: c, offset: f };
            ...
            (s = V.create({
              ...
              onUpdate: function onUpdate(e) {
                ...
                if (e.offset) {
                  if (i) {
                    for (r = -H, n = e.end; i--; ) {
                      if ((t = p[i]).trig.isActive || (r >= t.start && r <= t.end)) return void (l && ((t.trig.progress += t.trig.direction < 0 ? 0.001 : -0.001), t.trig.update(0, 0, 1), l.resetTo("y", parseFloat(g.y), -M, !0), N && l.progress(1)));
                  ...
                  m.length &&
                    ...
                    l ? (l.resetTo("y", o, -M, !0), N && l.progress(1)) : ((g.y = o + "px"), g.renderTransform(1));
                }
              },
            }))
          ),
    ...
    var n,
      ...
      x = t.effectsPrefix || "",
      P = V.getScrollFunc(U),
      k = 1 === V.isTouch ? (!0 === p ? 0.8 : parseFloat(p) || 0) : 0 === _ || !1 === _ ? 0 : parseFloat(_) || 0.8,
      A = (k && +t.speed) || 1,
      H = 0,
      M = 0,
      N = 1,
    ...
    Oa(),
      ...
      (this.scrollTo = function (e, t, r) {
        ...
        t ? (f ? I.to(o, { duration: k, scrollTop: n, overwrite: "auto", ease: Y }) : P(n)) : Ga(n);
      }),
      ...
      (this.content = function (e) {
        if (arguments.length) {
          ...
          return t !== n && ((c = (n = t).getAttribute("style") || ""), z && z.observe(n), I.set(n, { overflow: "visible", width: "100%", boxSizing: "border-box", y: "+=0" }), k || I.set(n, { clearProps: "transform" })), this;
        }
        return n;
      }),
      (this.wrapper = function (e) {
        return arguments.length
          ? ((S =
            ...
            refreshHeight(),
            I.set(S, k ? { overflow: "hidden", position: "fixed", height: "100%", width: "100%", top: 0, left: 0, right: 0, bottom: 0 } : { overflow: "visible", position: "relative", width: "100%", height: "auto", top: "auto", bottom: "auto", left: "auto", right: "auto" }),
            this)
          : S;
      }),
    ...
    B.forEach(function (e) {
      ...
      (i = V.create({
        ...
        onRefresh: function onRefresh(e) {
          e.animation.invalidate(), e.setPositions(e.start, refreshHeight() / A), h || Ea(e), (O.y = -P() * A), Fa(O.y), N || e.animation.progress(I.utils.clamp(0, 1, u / A / -e.end)), h && ((e.progress -= 0.001), e.update()), (ScrollSmoother.isRefreshing = !1);
        },
        id: "ScrollSmoother",
        scroller: U,
      ...
      t.effects && this.effects(!0 === t.effects ? "[data-" + x + "speed], [data-" + x + "lag]" : t.effects, { effectsPadding: t.effectsPadding }),
        ...
        return arguments.length
          ? (!!f !== e &&
              (e
                ...
                : (f.nested.kill(), f.kill(), (f = 0), r && r.enable(), (i.progress = (-H / A - i.start) / (i.end - i.start)), Ea(i))),
            this)
          : !!f;
      }),
      (this.kill = this.revert =
        function () {
          ...
          var r = V.defaults({});
          r && r.scroller === S && V.defaults({ scroller: U }), o.normalizer && V.normalizeScroll(!1), clearInterval(a), (J = null), z && z.disconnect(), K.style.removeProperty("height"), U.removeEventListener("focusin", Ja);
        }),
      (this.refresh = function (e, t) {
        return i.refresh(e, t);
      }),
      C && (this.normalizer = V.normalizeScroll(!0 === C ? { debounce: !0, content: !k && n } : C)),
      V.config(t),
      "overscrollBehavior" in U.getComputedStyle(K) && I.set([K, j], { overscrollBehavior: "none" }),
      "scrollBehavior" in U.getComputedStyle(K) && I.set([K, j], { scrollBehavior: "auto" }),
